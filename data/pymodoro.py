...
# Files and Folders
pymodoro_directory_config = os.path.dirname(os.path.realpath(__file__))
...
session_sound_file = pymodoro_directory + '/tones/' + session_sound_file_config
break_sound_file = pymodoro_directory + '/tones/' + break_sound_file_config
tick_sound_file = pymodoro_directory + '/tones/' + tick_sound_file_config
